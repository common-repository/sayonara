...
class Sayonara_Blank_Slate {
	...
	*/
	...
	/**
	* Constructs the Sayonara_Blank_Slate class.
	*
	* @since 1.0.0
	*/
	...
	*/
	public function init() {
		...
		$this->form = $this->post_exists( 'sayonara' );

		// Check we are on the report list page
		if ( $this->screen == 'edit-sayonara') {
			if ( $this->form ) {
	...
	*/
	public function render( $which = 'bottom' ) {
		...
		$template_path = plugin_dir_path( dirname( __FILE__ ) ) . 'admin/partials/sayonara-blank-slate.php';
